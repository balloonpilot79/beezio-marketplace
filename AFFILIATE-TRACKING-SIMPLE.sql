...
-- SIMPLIFIED VERSION - Run this instead
-- Copy ALL of this and run in Supabase SQL Editor

-- Step 1: Create the new tables first (no dependencies on orders table)
-- =====================================================================
...
-- Step 4: Create function to auto-generate affiliate links when product is added
-- =====================================================================
