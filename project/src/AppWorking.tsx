...
const AppWorking: React.FC = () => {
  ...
  const HomeOrDashboard = () => {
    const { user } = useAuth();
    return user ? <Dashboard /> : <HomePageBZO onOpenSimpleSignup={() => setShowSimpleSignup(true)} />;
  };
              ...
              <div className="min-h-screen bg-bzo-gradient">
                ...
                <main className="pt-16">
                  <Routes>
                    ...
                    <Route path="/admin/cj-import" element={<AdminRoute><CJProductImportPage /></AdminRoute>} />
