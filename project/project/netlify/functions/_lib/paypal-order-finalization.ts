  ...
  const plan = normalizePlanHoldReleaseAt(stripBuyerCommissionRoles(applyLegacyLedgerFallbacks({
    plan: buildPayPalLedgerPlan({
      ...
      items: rows.map((row: any) => ({
        ...
        supplier_cost_amount: row?.supplier_cost_amount == null ? undefined : Number(row.supplier_cost_amount),
        seller_markup_amount: row?.seller_markup_amount == null ? undefined : Number(row.seller_markup_amount),
        affiliate_payout_amount: row?.affiliate_payout_amount == null ? undefined : Number(row.affiliate_payout_amount),
        shipping_reserve_amount: row?.shipping_reserve_amount == null ? undefined : Number(row.shipping_reserve_amount),
        influencer_allocation_amount: row?.influencer_allocation_amount == null ? undefined : Number(row.influencer_allocation_amount),
        platform_fee_amount: row?.platform_fee_amount == null ? undefined : Number(row.platform_fee_amount),
        paypal_processing_allowance: row?.paypal_processing_allowance == null ? undefined : Number(row.paypal_processing_allowance),
