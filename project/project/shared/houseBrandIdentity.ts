...
export const HOUSE_BRAND_IDENTITIES: Record<HouseBrandSlug, HouseBrandIdentity> = {
  ...
  redtail: {
    ...
    name: 'RedTail',
    personality: 'western',
    headerLabel: 'Automotive performance',
    kicker: 'Automotive detailing • protection • performance',
    about: 'RedTail is an independent automotive care brand focused on detailing, protection, and performance essentials.',
    heroUrl: '/redtail-editorial-hero.png',
