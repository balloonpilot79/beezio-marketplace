...
const AffiliatePage: React.FC = () => {
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      <h1 className="text-4xl font-bold mb-6 text-amber-600">Partner Program</h1>
      <div className="bg-white border border-gray-200 rounded-lg p-6 mb-8 shadow">
        <h2 className="text-2xl font-semibold mb-4">How to Earn as a Partner</h2>
        ...
        <a href="/signup" className="inline-block bg-amber-500 text-white px-6 py-3 rounded-lg font-bold hover:bg-amber-600 transition-colors">Sign Up as Partner</a>
      </div>
