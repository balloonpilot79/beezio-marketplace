...
import { ArrowRight, BadgeDollarSign, Briefcase, PackageCheck, ShieldCheck, Store, Users } from 'lucide-react';
...
const roleCards = [
  ...
  {
    icon: Briefcase,
    audience: 'Future opportunity',
    title: 'Independent contractor',
    detail: 'Beezio may offer optional, performance-based sales opportunities under separate contractor terms. This program is not open yet.',
    action: 'Program under review',
    to: null,
  },
];
      ...
      <div className="space-y-5 sm:space-y-8">
        ...
        <section className="rounded-[28px] border border-slate-200 bg-white px-5 py-9 text-[#101820] shadow-xl sm:px-8 sm:py-12">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl">Clear earning paths for independent businesses and promoters.</h2>
          ...
          <p className="mt-5 text-xs leading-5 text-slate-500">Independent-contractor opportunities would require a separate application, written agreement, and eligibility terms before launch.</p>
        </section>
