      ...
      <div className="space-y-4">
        ...
        {!profile?.stripe_account_id && (
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-sm text-amber-900">
            To receive payouts and commissions, connect your Stripe account from the Dashboard → Payments tab.
            <div className="mt-3">
              <Link
                to="/onboarding"
                className="inline-flex items-center px-4 py-2 rounded-full bg-[#101820] text-white text-sm font-semibold hover:bg-gray-800 transition-colors"
              >
                Finish Stripe setup
              </Link>
            </div>
